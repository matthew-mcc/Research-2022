...
//         //Vector2 startingPos = rb.transform.position;
...
//             rb.transform.position = new Vector2(rb.transform.position.x, movePos); //Needs to be scaled a bit, dependant on what lucie wants
//             //Debug.Log(val);
